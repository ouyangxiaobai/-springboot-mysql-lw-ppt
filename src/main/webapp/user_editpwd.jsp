	...
	<input type="hidden" name="user_id" 
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="password" name="user_password" required lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="new_user_password" required lay-verify="required"
	...
	(function($) {
		layui.use(['form','upload'], function() {
			...
			form.on('submit(user-edit-form-commit)', function(data) {
				data.field.new_user_password = $.md5(data.field.new_user_password);
