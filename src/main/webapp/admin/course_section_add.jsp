...
<div class="content" style="margin-top: 40px">
	...
	<form class="layui-form" action="" id="section-add-form">
		<input type="hidden" name="chapter_id" class="layui-input" value="${chapter_id}">
		<input type="hidden" name="course_id" class="layui-input" value="0">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<input type="text" name="section_video_path" required lay-verify="required" style="margin-top: 10px;"
					placeholder="assets/video/您放于该目录下的视频文件名mp4格式，示例：assets/video/video1.mp4" autocomplete="off" class="layui-input" >
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-upload" style="margin-left: 110px;">
				  <button type="button" class="layui-btn" id="section-add-form-file-commit">上传图片</button>
				  <div class="layui-upload-list">
				    <img class="layui-upload-img" id="section-add-form-file-img-preview" style="width: 150px;height: 150px;">
				    <p id="section-add-form-file-text"></p>
				  </div>
			</div>   
		</div>   
		...
		<div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		      <textarea name="section_info" placeholder="请输入简介" maxlength="1024" class="layui-textarea"></textarea>
		    </div>
		  </div>
		  <div class="layui-form-item layui-form-text">
		...
		<div class="layui-form-item" >
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit
					lay-filter="section-add-form-commit">立即提交</button>
...
<script>
	(function($) {
		layui.use(['form','upload'], function() {
			...
			//监听提交
			form.on('submit(section-add-form-commit)', function(data) {
		...
		//上传文件
		  var uploadInst = upload.render({
			  elem: '#section-add-form-file-commit' //绑定元素
				    ,field:'img'
				    ,url: '<%=PATH%>/file/upload.do' //上传接口
			        ,before: function(obj){
			          //预读本地文件示例，不支持ie8
			          obj.preview(function(index, file, result){
			            $('#section-add-form-file-img-preview').attr('src', result); //图片链接（base64）
			          });
			        }
			        ,done: function(res){
			        	 if(res.success){
			        ...
			        ,error: function(){
			          //演示失败状态，并实现重传
			          var demoText = $('#section-add-form-file-text');
