...
<div class="content" style="margin-top: 40px">
	...
	<form class="layui-form" action="" id="homework-add-form">
		...
		<div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		      <textarea name="homework_content" placeholder="请输入内容" maxlength="1024" class="layui-textarea"></textarea>
		    </div>
		  </div>
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit
					lay-filter="homework-add-form-commit">立即提交</button>
...
<script>
	(function($) {
		layui.use(['form','upload'], function() {
			...
			//监听提交
			form.on('submit(homework-add-form-commit)', function(data) {
				$.ajax({
					url : 'add.do',
					data : data.field,
					type : 'post',
