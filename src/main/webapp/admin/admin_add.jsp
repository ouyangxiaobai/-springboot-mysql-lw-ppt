...
<div class="content" style="margin-top: 40px">
	...
	<form class="layui-form" action="" id="admin-add-form">
	<input type="hidden" name="admin_issystem" 
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit
					lay-filter="admin-add-form-commit">立即提交</button>
...
<script>
	(function($) {
		layui.use(['form','upload'], function() {
			...
			//监听提交
			form.on('submit(admin-add-form-commit)', function(data) {
				$.ajax({
					url : 'add.do',
					data : data.field,
					type : 'post',
