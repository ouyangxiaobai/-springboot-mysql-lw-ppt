...
<div class="content" style="margin-top: 40px">
	...
	<input type="hidden" name="result_id" 
					class="layui-input" value="${detail.result_id}">
		<div class="layui-form-item">
			<label class="layui-form-label">评分</label>
			<div class="layui-input-inline">
				<input type="number" name="result_score" required
					lay-verify="required" placeholder="请输入评分" autocomplete="off"
					class="layui-input" value="${detail.result_score}">
			</div>
		...
		<hr>
		<div id="result-content" style="padding: 20px 20px;"></div>
	</form>
</div>
...
<script>
	(function($) {
		layui.use(['form','upload'], function() {
			...
			$('#result-content').html('${detail.result_content}');
		});
